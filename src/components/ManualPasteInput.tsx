    ...
    <div className="max-w-3xl mx-auto rounded-2xl border border-slate-700/80 bg-slate-900/80 backdrop-blur-sm shadow-sm p-8">
      ...
      <label className="block">
        ...
        <input
          ...
          className="mt-1.5 w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-100"
        />
      </label>
      ...
      <label className="block mt-5">
        ...
        <textarea
          ...
          rows={16}
          className="mt-1.5 w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2.5 font-mono text-[13px] leading-relaxed outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-100"
        />
      </label>
      ...
      <div className="mt-5 flex items-center justify-between gap-4 flex-wrap">
        <div className="text-sm text-slate-300 inline-flex items-center gap-2">
          {text.trim() === "" ? (
            ...
            <span className="text-slate-500">No content detected.</span>
          ) : (
            <>
