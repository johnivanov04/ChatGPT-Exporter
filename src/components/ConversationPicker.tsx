    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="relative mb-5">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-700 bg-slate-900 pl-10 pr-24 py-2.5 text-sm outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-100"
        />
        {query && (
          <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] font-medium text-slate-400 bg-slate-800 px-2 py-0.5 rounded-full">
