    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="relative mb-5">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-200 bg-white pl-10 pr-24 py-2.5 text-sm outline-none transition focus:border-violet-400 focus:ring-2 focus:ring-violet-100"
        />
        {query && (
          ...
          {filtered.map((c) => (
            <li key={c.id}>
              <button
                type="button"
                onClick={() => onSelect(c)}
                className="group w-full text-left rounded-xl border border-slate-200/80 bg-white p-4 hover:border-violet-300 hover:shadow-md hover:shadow-violet-500/5 hover:-translate-y-0.5 transition-all duration-150 focus-ring"
              >
